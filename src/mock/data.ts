import { Patient, Doctor, Staff, Appointment, Inquiry, Prescription, ActivityLog, User, NotificationItem } from '../types';
...
export const INITIAL_PRESCRIPTIONS: Prescription[] = [
  ...
  },
  {
    ...
    refillsTotal: 6,
    refillsRemaining: 4,
    directions: 'Take 6 tablets ONCE WEEKLY on Mondays',
    status: 'Filled',
    prescribedDate: '2026-06-28',
    fillDueDate: '2026-07-28',
    copayAmount: 8.00,
    insuranceStatus: 'Approved'
  }
];
