import { Patient, Doctor, Staff, Appointment, Inquiry, Prescription, ActivityLog, User, NotificationItem, SystemUser, SystemRole, Supplier, Manufacturer, MedicineItem, StockTransaction, ActivityCategory, Activity, BlogPost, PatientBill } from '../types';
...
export const INITIAL_SUPPLIERS: Supplier[] = [
  {
    ...
    email: 'd.miller@amerisource.com',
    phone: '(800) 555-0199',
    ...
    rating: 4.9,
    status: 'Preferred',
    address: '1 West First Ave, Conshohocken, PA',
  },
  {
    id: 'sup-2',
    code: 'SUP-88202',
    ...
    rating: 4.8,
    status: 'Active',
    address: '6555 State Hwy 161, Irving, TX',
  },
  {
    id: 'sup-3',
    code: 'SUP-88203',
    ...
    phone: '(800) 555-0311',
    categories: ['Brand Biologics', 'Cold Chain / Insulins'],
    paymentTerms: 'Net 30',
    leadTimeDays: 1.2,
    rating: 4.7,
    status: 'Active',
    address: '7000 Cardinal Pl, Dublin, OH',
  },
  {
    id: 'sup-4',
    code: 'SUP-88204',
    ...
    email: 'acole@medline.com',
    phone: '(800) 555-0488',
    categories: ['OTC & First Aid', 'Surgical Supplies'],
    paymentTerms: 'Net 45',
    leadTimeDays: 3.0,
    rating: 4.3,
    status: 'Under Review',
    address: 'Three Lakes Dr, Northfield, IL',
  },
];
...
export const INITIAL_MANUFACTURERS: Manufacturer[] = [
  {
    ...
    activeDrugLines: 42,
    contactEmail: 'medical.info@pfizer.com',
    contactPhone: '(800) 223-0182',
    status: 'Active',
  },
  {
    id: 'mfg-102',
    ...
    activeDrugLines: 28,
    contactEmail: 'inquiries@novartis.com',
  ...
  },
  {
    ...
    country: 'Israel',
    fdaRegistrationNo: 'FDA-REG-8820192',
    qualityStatus: 'FDA Approved',
    activeDrugLines: 65,
    contactEmail: 'info@tevapharm.com',
    contactPhone: '(888) 838-2872',
    status: 'Active',
  },
  {
    id: 'mfg-104',
    code: 'MFG-9004',
    name: 'Sandoz Generics',
    country: 'Germany',
    fdaRegistrationNo: 'FDA-REG-5510293',
    qualityStatus: 'ISO 9001',
    activeDrugLines: 34,
    contactEmail: 'contact@sandoz.com',
    contactPhone: '+49 8024 4760',
    status: 'Active',
  },
];
...
export const INITIAL_STOCK_TRANSACTIONS: StockTransaction[] = [
  {
    ...
    previousStock: 50,
    newStock: 550,
    performedBy: 'Dr. Sarah Jenkins, PharmD',
  ...
  },
  {
    ...
    drugName: 'Metformin HCl ER 500mg',
    batchNo: 'LOT-44102B',
    type: 'Prescription Dispensed',
    quantity: -60,
    previousStock: 78,
    newStock: 18,
    performedBy: 'Elena Rostova, PharmD',
