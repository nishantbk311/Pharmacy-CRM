      ...
      <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200/80 shadow-xs flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-emerald-600 dark:bg-emerald-500 text-white font-bold text-xs hover:bg-emerald-700 dark:hover:bg-emerald-600 transition-colors flex items-center gap-2 shadow-xs"
          >
          ...
          >
            <div className="space-y-3">
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 rounded-2xl bg-indigo-50 text-indigo-700 font-bold flex items-center justify-center text-base border border-indigo-200/60 shrink-0">
                    Dr
                  </div>
                  <div>
            ...
            <div className="pt-3 border-t border-slate-100 flex items-center justify-between text-xs">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-indigo-50 text-indigo-700 hover:bg-indigo-100 font-bold flex items-center gap-1.5 transition-colors"
              >
      ...
      >
        <form onSubmit={handleAddDoctor} className="space-y-3 text-xs">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
              <label className="block font-semibold text-slate-700 mb-1">NPI 10-Digit Identifier</label>
              <input
                type="text"
                value={npiNumber}
          ...
          <div>
            <label className="block font-semibold text-slate-700 mb-1">Doctor Email</label>
            <input
              type="email"
              value={email}
      ...
      {inquiryDoctor && (
        ...
        >
          <form onSubmit={handleSendInquiry} className="space-y-3 text-xs">
            <div>
              <label className="block font-semibold text-slate-700 mb-1">Query Subject / Reason *</label>
              <input
                type="text"
                required
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="block font-semibold text-slate-700 mb-1">Related Patient</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block font-semibold text-slate-700 mb-1">Related Rx Number</label>
                <input
                  type="text"
                  value={inquiryRx}
            ...
            <div>
              <label className="block font-semibold text-slate-700 mb-1">Description / Clinical Context</label>
              <textarea
                rows={3}
                value={inquiryDesc}
